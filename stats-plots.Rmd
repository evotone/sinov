...
Since the lengths of the lexicon and the SV list are both constant, this means that O/E is linearly proportional to the percentage of occurrences in the SV layer (here, **SV/total** $\times$ 4.234141). 
...
```{r, echo=FALSE}
fmt_table(uni_live, 6, 190)
```

<button class="btn btn-primary" data-toggle="collapse" data-target="#Live">Show/hide histogram</button>
<div id="Live" class="collapse"> 
...
```{r, echo=FALSE}
fmt_table(uni_dead, 6, 65)
```

<button class="btn btn-primary" data-toggle="collapse" data-target="#Dead">Show/hide histogram</button>
<div id="Dead" class="collapse"> 
